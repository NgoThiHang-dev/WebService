...
<body>
    ...
    $svArr = array();
    $svArr[] = new SinhVien("Ngô Thị Hằng", "CTK41", 9, "1710166@dlu.edu.vn", "123");
    $svArr[] = new SinhVien("Nguyen A", "CTK41", 8.5, "a@dlu.edu.vn", "123");
    $svArr[] = new SinhVien("Lâm Vỹ Dạ", "CTK40", 9.5, "lvd@dlu.edu.vn", "123");
